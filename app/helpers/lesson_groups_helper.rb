module LessonGroupsHelper
  def get_next_path(lesson_group)
    ...
    return link_to 'End', lesson_path(lesson_group.lesson.lower_active_item), data: {turbo_frame: '_top' }, class: "px-12 py-3 bg-orange-100 hover:bg-orange-200 transition-all no-underline" if lesson_group.lesson.lower_active_item.present? 
