...
class MultipleOpenBlocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should get new" do
    get new_multiple_open_block_url
    assert_response :success
  end

  test "should create multiple_open_block" do
    assert_difference("MultipleOpenBlock.count") do
      post multiple_open_blocks_url, params: { multiple_open_block: { body: @multiple_open_block.body, title: @multiple_open_block.title } }
    end

    assert_redirected_to multiple_open_block_url(MultipleOpenBlock.last)
  end
