...
ActiveRecord::Schema[7.0].define(version: 2022_12_04_141835) do
  ...
  create_table "multiple_open_answers", force: :cascade do |t|
    ...
    t.index ["user_id", "multiple_open_piece_id"], name: "index_mult_op_answers_on_user_and_mult_op_piece", unique: true
  ...
  create_table "notifications", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["notifeable_type", "notifeable_id"], name: "index_notifications_on_notifeable"
  ...
  create_table "study_sessions", force: :cascade do |t|
    ...
    t.index ["lesson_group_id"], name: "index_study_sessions_on_lesson_group_id"
  ...
  create_table "user_text_answers", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id", "user_text_block_id"], name: "index_user_text_answers_on_user_id_and_user_text_block_id", unique: true
  ...
  create_table "youtube_blocks", force: :cascade do |t|
    t.string "url"
    t.text "code"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
